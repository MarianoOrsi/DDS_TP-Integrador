				...
				<div class="container">
					<div id="column1" style="float:left; margin:0; width:33%;">
						<table id="groupsTable" border="1">
							...
							$result = mysql_query("SELECT recetas.IdReceta, recetas.Receta, SUM(puntuaciones.Puntuacion) as Puntuacion FROM recetas LEFT JOIN puntuaciones ON puntuaciones.IdReceta = recetas.IdReceta GROUP BY recetas.IdReceta", $con);
